...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.DaftarPet.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('warna_tanda') is-invalid @enderror" id="warna_tanda" name="warna_tanda"
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('idpemilik') is-invalid @enderror" name="idpemilik" id="idpemilik" required>
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('idras_hewan') is-invalid @enderror" name="idras_hewan" id="idras_hewan" required>
