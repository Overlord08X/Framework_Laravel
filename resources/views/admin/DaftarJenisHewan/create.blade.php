        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.DaftarJenisHewan.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                placeholder="Masukkan mama jenis hewan"
                                required>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.DaftarJenisHewan.index') }}" class="btn btn-secondary">
