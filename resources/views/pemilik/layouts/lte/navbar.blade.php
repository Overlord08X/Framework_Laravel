<nav class="app-header navbar navbar-expand bg-body">
    <div class="container-fluid">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="{{ route('perawat.dashboard-perawat') }}" class="nav-link">Home</a></li>
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-footer">
                        <a href="{{ route('pemilik.Profil.index') }}" class="btn btn-default btn-flat">Profile</a>
